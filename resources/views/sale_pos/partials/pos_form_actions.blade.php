...
<div class="row">
	<div class="pos-form-actions">
		<div class="col-md-12">
			...
			{{-- <button type="button" {{ route('customer-group.create') }} class="btn btn-Debt bg-red btn-flat @if($is_mobile) col-xs-6 @endif" id="pos-quotation"> <i class="fa-solid fa-sack-dollar"></i> Debt</button> --}}
				<a href="{{ route('customer-group.index') }}" class="btn btn-Debt bg-red btn-flat" id="pos-quotation"> <i class="f
					...
					a-solid fa-sack-dollar"></i>0Debt</a>
