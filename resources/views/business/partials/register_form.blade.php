    ...
    <div class="login-form col-md-12 col-xs-12 right-col-content">
        <div  style="margin-top:60%">
            ...
            <form method="POST" action="{{ route('login') }}" id="login-form">
                ...
                <br>
                <div class="form-group">
                    <button type="submit" class="btn btn-flat btn-login" style="background-color:rebeccapurple;color:#fff;width:100%">@lang('lang_v1.login')</button>
                    @if(config('app.env') != 'demo')
                    <a style="font-size:11px;margin-top:5px;margin-left:10px" href="{{ route('password.request') }}" class="pull-right">
                        @lang('lang_v1.forgot_your_password')
                    </a>
                    <a style="font-size:11px;margin-top:5px;margin-left:10px" href="{{ route('login') }}" class="pull-right">
                        @lang('lang_v1.login')
                    </a>
                @endif
                </div>
