    ...
    <table class="table table-bordered table-striped ajax_view hide-footer" id="product_table">
        <thead>
            <tr>
                ...
                <th style="font-size:12px;">@lang('product.sku')</th>
                <th style="font-size:10px;">{{ $custom_labels['product']['custom_field_1'] ?? __('lang_v1.product_custom_field1') }}</th>
                <th style="font-size:10px;">{{ $custom_labels['product']['custom_field_2'] ?? __('lang_v1.product_custom_field2') }}</th>
                <th style="font-size:10px;">{{ $custom_labels['product']['custom_field_3'] ?? __('lang_v1.product_custom_field3') }}</th>
                <th style="font-size:10px;">{{ $custom_labels['product']['custom_field_4'] ?? __('lang_v1.product_custom_field4') }}</th>
            </tr>
        </thead>
        <tfoot>
            <tr>
