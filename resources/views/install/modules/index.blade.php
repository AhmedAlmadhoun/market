...
<section class="content-header">
    <h1>
        ...
        <small>Sadece Süperadmin Yönetim Modülüne Erişebilir</small>
    </h1>
    <!-- <ol class="breadcrumb">
                    ...
                    <td>
                        ...
                        @else
                            <a class="btn btn-warning btn-xs"
                                ...
                                @endif
                                onclick="return confirm('Modülü gerçekten kaldırmak istiyor musunuz? Modül kaldırılacak ancak veriler silinmeyecek')"
                        ...
                        <form 
                            action="{{action('Install\ModulesController@destroy', ['module_name' => $module['name']])}}"
                                style="display: inline;" 
                                method="post"
                                onsubmit="return confirm('Modülü gerçekten kaldırmak istiyor musunuz? Modül kaldırılacak ancak veriler silinmeyecek')"
                            >
                                @method('DELETE')
                                @csrf
