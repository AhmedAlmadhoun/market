	...
	@while($details['qty'] > 0)
		...
		<div style="display:inline-block;vertical-align:middle;line-height:16px !important;">
			...
			@if(!empty($print['business_name']))
				<b style="display: block !important;font-weight:unset;font-size:13px" class="text-uppercase">{{$business_name}}</b>
			@endif

			{{-- Product Name --}}
			@if(!empty($print['name']))
				<span style="display: block !important;font-size:13px">
			...
			@if(!empty($print['variations']) && $details['details']->is_dummy != 1)
				<span style="display: block !important;font-size:13.5px">
			...
			@if(!empty($print['price']))
				<b style="font-weight:unset;font-size:13.7px;font-weight:bold">@lang('lang_v1.price'):</b>
			...
			<br>
			{{-- Barcode --}}
			<img class="center-block" style="max-width:95%; !important;height: {{$barcode_details->height*0.35}}in !important;" src="data:image/png;base64,{{DNS1D::getBarcodePNG($details['details']->sub_sku, $details['details']->barcode_type, 3,30,array(39, 48, 54), true)}}">
...
<div class="btn btn-success" style="text-align:center"><button class="btn btn-success" style="background-color:rebeccapurple;color:#fff;padding:4px;border-radius:20px;font-size:2em" onclick="window.print()"><img src ="https://www.codeline.com.tr/wp-content/uploads/2019/07/argox-os214-plus-1.png" style="width:50px"><br>Yazdır</button></div>
