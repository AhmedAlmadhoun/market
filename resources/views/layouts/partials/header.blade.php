  ...
  <header class="main-header no-print">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="navbar-custom-menu">
        ...
        @endif
        <!--<a href="{{action('HomeController@screen')}}" title="@lang('sale.pos_sale')" data-toggle="tooltip" target="_blank" data-placement="bottom" class="btn btn-primary btn-flat pull-left m-8 hidden-xs btn-sm mt-10">
              <strong><i class="fa fa-desktop fa-lg"></i> &nbsp; @lang('sale.customer_screen')</strong>
            </a>-->
