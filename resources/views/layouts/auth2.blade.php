        ...
        <div class="row eq-height-row">
            <div class="col-md-8 col-sm-8 hidden-xs left-col eq-height-col" >
                <div class="left-col-content login-header"> 
                    ...
                    @else
                       {{ config('app.name', 'MorPos') }}
                    @endif 
                    </a>
                    <br/>
                    @if(!empty(config('constants.app_title')))
                        <small style="display:none">{{config('constants.app_title')}}</small>
                    @endif
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-12 right-col eq-height-col" style="background:#4e3960 !important">
                <div class="row">
