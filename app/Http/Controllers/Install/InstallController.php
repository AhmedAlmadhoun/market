    ...
    public function postDetails(Request $request)
    {
        ...
        try {
            ...
            $validatedData = $request->validate(
                [
                'APP_NAME' => 'required',
                'MOROFIS_PURCHASE_CODE' => 'required',
                ...
                [
                    ...
                    'MOROFIS_PURCHASE_CODE.required' => 'Morofis Satınalma Kodu Gereklidir.',
            ...
            $input = $request->only(['APP_NAME', 'APP_TITLE', 'DB_HOST', 'DB_PORT', 'DB_DATABASE', 'DB_USERNAME', 'DB_PASSWORD', 'MOROFIS_PURCHASE_CODE',
                'MAIL_DRIVER',
