...
<html lang="en">
  <head>
    ...
    <title>Kurulum Öncesi Bazı Kontroller...</title>
  ...
  <body>
  	<div class="container">
		...
		<center>
			<h2>Kurulum Öncesi Bazı Kontroller...</h2><br/>
		</center>
	...
	<table class="table">
		...
		<tr>
			<td class="col-md-6">
				...
				?>
				Depolama Dizini Yazılabilir Yetkide mi?
			</td>
			<td class="col-md-6">
				<?php
					if($is_writable){
						...
						echo "<i class='glyphicon glyphicon-remove text-danger' aria-hidden='true'></i>";
						echo "<br/>Lütfen <i>$storage_path</i> yolu için yazılabilir (yinelemeli) izin verin";
						$all_ok = false;
					}
				?>
			</td>
		...
		<tr>
			<td>
				Önbellek Dizini Yazılabilir Yetkide mi?
				<?php
			...
			<td>
				<?php
					if(is_writable($cache_path)){
						...
						echo "<i class='glyphicon glyphicon-remove text-danger' aria-hidden='true'></i>";
						echo "<br/>Lütfen <i>$cache_path</i> yolu için yazılabilir izin verin";
						$all_ok = false;
					}
				?>
			</td>
		...
		<tr>
			<td>
				Yüklemeler Dizini Yazılabilir Yetkide mi?
				<?php
			...
			<td>
				<?php
					if(is_writable($upload_path) && is_writable($upload_b_logo) && is_writable($upload_b_doc) && is_writable($upload_b_img) && is_writable($upload_i_logo)){
						...
						echo "<i class='glyphicon glyphicon-remove text-danger' aria-hidden='true'></i>";
						echo "<br/>Lütfen <i>$upload_path</i> yolu için yazılabilir (yinelemeli) izin verin";
						$all_ok = false;
					}
				?>
			</td>
	...
	<center>
		...
		<p>
			<?php
				if($all_ok){
					echo "<span class='text-success'>Tüm ayarlar doğru görünüyor. <a href=$install_link>Sonraki Adım</a>' a Geç</span>";
				} else {
					echo "<span class='text-danger'>Bazı ayarlar yanlış. Düzeltin ve bu sayfayı yenileyin</span>";
				}
			?>
		</p>
	</center>
